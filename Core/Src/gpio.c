...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : ARD_D5_Pin ARD_lab_Pin */
  GPIO_InitStruct.Pin = ARD_D5_Pin|ARD_lab_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : ARD_D6_Pin ARD_D3_Pin */
  ...
  /*Configure GPIO pins : EXT_RST_Pin ARD_D9_Pin */
